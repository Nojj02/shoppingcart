...
public abstract class PostgresRepository<T extends AggregateRoot<TId>, TId extends Identity>
    ...
    protected PostgresRepository(ConnectionManager connectionManager, Class<T> classOfT, String tableName) {
    ...
    public void update(T entity)
        ...
        try (var connection = this.connectionManager.connect();
            ...
            preparedStatement.setObject(2, entity.getId().getValue());
            preparedStatement.execute();
        } catch (SQLException e) {
            throw e;
        } catch (JsonProcessingException e) {
    ...
    @Override
    public Optional<T> get(TId identity) throws SQLException {
        return get(identity.getValue());
    }
